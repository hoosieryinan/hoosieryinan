# Examples for Max Business Builder

## Example 1: Rough notes to structured output

**Input from Max**
```text
Use max-business-builder. I need to update management. Migration is mostly okay but vendor delayed permission report. Need avoid blaming them too directly. Ask for decision on whether we continue pilot next week.
```
