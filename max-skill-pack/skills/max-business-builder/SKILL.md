# Max Business Builder

## 1. Skill name
`max-business-builder`

## 2. Purpose
Help Max plan and grow business projects such as 每日爪力, pet product branding, exhibition planning, product positioning, customer pain-point analysis, and AI customer service.

## 3. When to use this skill
Use this skill when Max asks for help with business plans, brand positioning, product strategy, exhibitions, AI customer service. Trigger it for rough notes, incomplete ideas, meeting context, copied email threads, screenshots converted to text, or requests such as "make this professional", "what should I do next", "prepare a plan", or "turn this into a template".
...
- "Use `max-business-builder` to turn these messy notes into an executive update."
- "Use `max-business-builder` and give me options, risks, recommendation, and next steps."
- "Use `max-business-builder` to write a professional English email from this Chinese context."
- "Use `max-business-builder` to create a reusable template I can use again."
