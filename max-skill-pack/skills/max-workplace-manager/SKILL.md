# Max Workplace Manager

## 1. Skill name
`max-workplace-manager`

## 2. Purpose
Help Max handle workplace communication, task prioritization, stakeholder management, meeting preparation, weekly planning, and management-level updates.

## 3. When to use this skill
Use this skill when Max asks for help with workplace priorities, stakeholder messages, meeting prep, weekly planning, management updates. Trigger it for rough notes, incomplete ideas, meeting context, copied email threads, screenshots converted to text, or requests such as "make this professional", "what should I do next", "prepare a plan", or "turn this into a template".
...
- "Use `max-workplace-manager` to turn these messy notes into an executive update."
- "Use `max-workplace-manager` and give me options, risks, recommendation, and next steps."
- "Use `max-workplace-manager` to write a professional English email from this Chinese context."
- "Use `max-workplace-manager` to create a reusable template I can use again."
