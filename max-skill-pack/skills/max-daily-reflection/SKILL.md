# Max Daily Reflection

## 1. Skill name
`max-daily-reflection`

## 2. Purpose
Help Max generate daily reflection, discipline tracking, fatherhood notes, self-improvement writing, and motivational content.

## 3. When to use this skill
Use this skill when Max asks for help with daily reviews, journals, habit tracking, fatherhood notes, self-improvement. Trigger it for rough notes, incomplete ideas, meeting context, copied email threads, screenshots converted to text, or requests such as "make this professional", "what should I do next", "prepare a plan", or "turn this into a template".
...
- "Use `max-daily-reflection` to turn these messy notes into an executive update."
- "Use `max-daily-reflection` and give me options, risks, recommendation, and next steps."
- "Use `max-daily-reflection` to write a professional English email from this Chinese context."
- "Use `max-daily-reflection` to create a reusable template I can use again."
