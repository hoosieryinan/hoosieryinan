...
## 2. Purpose
Help Max manage IT projects with scope, timeline, RACI, action items, decisions, dependencies, risks, vendor communication, and executive reporting.

## 3. When to use this skill
Use this skill when Max asks for help with project charters, plans, RAID logs, RACI, status reports, vendor follow-ups. Trigger it for rough notes, incomplete ideas, meeting context, copied email threads, screenshots converted to text, or requests such as "make this professional", "what should I do next", "prepare a plan", or "turn this into a template".
...
- "Use `max-project-pmo` to turn these messy notes into an executive update."
- "Use `max-project-pmo` and give me options, risks, recommendation, and next steps."
- "Use `max-project-pmo` to write a professional English email from this Chinese context."
- "Use `max-project-pmo` to create a reusable template I can use again."
