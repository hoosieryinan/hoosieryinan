...
## 2. Purpose
Help Max create governance frameworks, risk assessments, policy explanations, compliance summaries, and control models for enterprise IT.

## 3. When to use this skill
Use this skill when Max asks for help with governance frameworks, risks, controls, policies, compliance summaries. Trigger it for rough notes, incomplete ideas, meeting context, copied email threads, screenshots converted to text, or requests such as "make this professional", "what should I do next", "prepare a plan", or "turn this into a template".
...
- "Use `max-it-governance` to turn these messy notes into an executive update."
- "Use `max-it-governance` and give me options, risks, recommendation, and next steps."
- "Use `max-it-governance` to write a professional English email from this Chinese context."
- "Use `max-it-governance` to create a reusable template I can use again."
