...
## 2. Purpose
Help Max with Microsoft 365, SharePoint Online, Teams, retention labels, migration, storage analysis, permissions, PowerShell scripts, and operational troubleshooting.

## 3. When to use this skill
Use this skill when Max asks for help with M365, SharePoint, Teams, Purview, retention, migration, storage, PowerShell. Trigger it for rough notes, incomplete ideas, meeting context, copied email threads, screenshots converted to text, or requests such as "make this professional", "what should I do next", "prepare a plan", or "turn this into a template".
...
- "Use `max-m365-sharepoint` to turn these messy notes into an executive update."
- "Use `max-m365-sharepoint` and give me options, risks, recommendation, and next steps."
- "Use `max-m365-sharepoint` to write a professional English email from this Chinese context."
- "Use `max-m365-sharepoint` to create a reusable template I can use again."
