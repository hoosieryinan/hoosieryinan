# Max Executive Communication

## 1. Skill name
`max-executive-communication`

## 2. Purpose
Help Max write concise and professional emails, updates, summaries, escalation messages, meeting invitations, and stakeholder responses in English and Chinese.

## 3. When to use this skill
Use this skill when Max asks for help with emails, summaries, escalations, meeting invites, stakeholder replies. Trigger it for rough notes, incomplete ideas, meeting context, copied email threads, screenshots converted to text, or requests such as "make this professional", "what should I do next", "prepare a plan", or "turn this into a template".
...
- "Use `max-executive-communication` to turn these messy notes into an executive update."
- "Use `max-executive-communication` and give me options, risks, recommendation, and next steps."
- "Use `max-executive-communication` to write a professional English email from this Chinese context."
- "Use `max-executive-communication` to create a reusable template I can use again."
