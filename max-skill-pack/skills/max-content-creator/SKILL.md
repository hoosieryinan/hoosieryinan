...
## 2. Purpose
Help Max create Xiaohongshu, Douyin, WeChat, YouTube, and voice-over content around parenting, career, English learning, AI tools, and personal growth.

## 3. When to use this skill
Use this skill when Max asks for help with social posts, scripts, hooks, outlines, captions, content calendars. Trigger it for rough notes, incomplete ideas, meeting context, copied email threads, screenshots converted to text, or requests such as "make this professional", "what should I do next", "prepare a plan", or "turn this into a template".
...
- "Use `max-content-creator` to turn these messy notes into an executive update."
- "Use `max-content-creator` and give me options, risks, recommendation, and next steps."
- "Use `max-content-creator` to write a professional English email from this Chinese context."
- "Use `max-content-creator` to create a reusable template I can use again."
